...
class TestDatabase(unittest.TestCase):
    ...
    def test_02_insert_entry(self):
        ...
        result = cursor.fetchone()
        self.assertIsNotNone(result)
        # (id, app, title, text, timestamp, embedding_blob, filename)
        ...
        self.assertEqual(result[6], filename)
    ...
    def test_insert_duplicate_timestamp(self):
        ...
        id1 = insert_entry("First text", ts, embedding1, "App1", "Title1", "f1.webp")
        self.assertIsNotNone(id1)

        # Try inserting another entry with the same timestamp
        id2 = insert_entry("Second text", ts, embedding2, "App2", "Title2", "f2.webp")
    ...
    def test_get_all_entries_multiple(self):
        ...
        self.assertEqual(entries[0].filename, "f2.webp")
        ...
        self.assertEqual(entries[1].filename, "f1.webp")
        ...
        self.assertEqual(entries[2].filename, "f3.webp")
